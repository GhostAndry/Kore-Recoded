...
@CommandInfo(name = "gmsp", permission = "kore.gamemode.spectator", permission2 =  "kore.gamemode.*", permission3 = "kore.gamemode", moduleName = "gamemode")
public class CommandGMSP extends KoreCommand {
